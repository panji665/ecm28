            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        {{-- product attribute --}}
                        <div>
                            @foreach ($product->attributeValue->unique('product_attibute_id') as $key=>$attrValue)
                                <div class="row" style="margin-top: 2opx">
                                    <div class="col-xs-2">
                                        <p>{{$attrValue->productAttribute->name}}</p>
                                    </div>

                                    <div class="col-xs-10">
                                        <select width="200px" class="form-control" wire:model="s_attribute.{{$attrValue->productAttribute->name}}">
                                            @foreach ($attrValue->productAttribute->attributeValues->where('product_id', $product->id) as $pav)
